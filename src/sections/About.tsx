...
export const AboutSection = () => {
  return (
    <section className="min-h-screen flex flex-col items-center justify-center bg-white relative overflow-hidden">
      {/* Grid Background */}
      <div
        className="absolute inset-0 rotate-[75deg] bg-white bg-[linear-gradient(to_right,#e5e7eb_1.5px,transparent_1.5px),linear-gradient(to_bottom,#e5e7eb_1.5px,transparent_1.5px)] bg-[size:40px_40px] opacity-35 z-0 
      [mask-image:radial-gradient(circle_at_center,black_20%,transparent_70%)] [mask-repeat:no-repeat] [mask-size:100%_100%] "
      ></div>
