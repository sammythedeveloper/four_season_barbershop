  ...
  const vipServices = [
    {
      ...
      price: "$150",
      desc:
        "Luxury precision haircut, essential oil scalp massage, hot towel treatment, and premium product styling."
    },
    {
      ...
      price: "$120",
      desc:
        "Signature beard sculpting with gold-infused oils, steam facial, and high-frequency skin therapy."
    },
    {
      ...
      price: "$135",
      desc:
        "Scalp detox with silk serum infusion, deep-conditioning hair mask, and consultation."
    },
    {
      ...
      price: "$200",
      desc:
        "Haircut, beard shaping, steam razor shave, facial cleanse, hydration mask, and complimentary premium drink."
    },
    {
      ...
      price: "$110",
      desc:
        "Express haircut, under-eye treatment, shoulder massage, and luxury finishing touch — ideal for travelers."
    }
  ];
